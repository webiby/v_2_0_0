  ...
  return (
    <div className="min-h-screen p-4 bg-slate-100">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="">
            <img src="https://source.unsplash.com/random" alt="Service Image" className="w-full h-[70dvh] object-cover rounded-xl shadow-lg" />
            <div className="grid grid-cols-4 gap-2 mt-4">
                <img src="https://source.unsplash.com/random" alt="Service Image" className="w-full h-[20dvh] object-cover rounded-xl shadow-lg" />
                <img src="https://source.unsplash.com/random" alt="Service Image" className="w-full h-[20dvh] object-cover rounded-xl shadow-lg" />
                <img src="https://source.unsplash.com/random" alt="Service Image" className="w-full h-[20dvh] object-cover rounded-xl shadow-lg" />
                <img src="https://source.unsplash.com/random" alt="Service Image" className="w-full h-[20dvh] object-cover rounded-xl shadow-lg" />
            </div>
        ...
        <div className="text-slate-700 shadow-xl relative">
            <img src="https://source.unsplash.com/random" alt="Service Image" className="rounded-xl z-0 w-full h-full inset-0 absolute object-cover opacity-30" />
            <div className='z-10 relative p-4'>
                <h1 className="text-3xl font-bold">Hair Cut</h1>
                <hr />
                ...
                <div className='lg:flex text-left justify-evenly'>  
                    <div className="mt-4">
                        <h2 className="text-xl font-semibold">Service Quality</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
        <div className="mt-8">
            <h2 className="text-xl font-semibold">Other Suggested Services</h2>
