...
export default function TeamCardA() {
  return (
    <>
        <div className='py-2 px-4 rounded-xl h-full w-full bg-gradient-to-l from-pink-300 via-violet-300 to-blue-300 shadow-2xl shadow-slate-500 group text-slate-50'>
            <hr />
            <div className='md:flex items-center md:justify-between md:space-y-0 space-y-8'>
                <div className='md:flex items-center pt-2 group-hover:scale-105'>
                    ...
                    <div className='flex-row md:text-left'>
                        <div className='tracking-wide text-2xl font-extrabold uppercase text-slate-500 mb-2'>Parthrajsinh Jethwa</div>
                ...
                <div className='text-right justify-evenly flex space-x-4'>
